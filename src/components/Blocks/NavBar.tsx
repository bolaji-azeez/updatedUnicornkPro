...
const NavBar:React.FC = () => {
  return (
    <div className='bg-[#1239ac] p-2 justify-between border-2 h-[70px] left-[340px] rounded-[5px] text-[white] shadow-md top-5 right-10 bottom-0  flex items-center fixed '>
