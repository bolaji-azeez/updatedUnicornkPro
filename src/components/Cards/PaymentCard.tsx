...
const PaymentCard:React.FC = () => {
  return (
    ...
    <div className='p-5 h-[650px] w-[100%] text-center bg-[white] flex flex-col justify-center   sm:h-[1600px] md:h-[1520px] lg:h-[600px] ' >
        ...
        '>
            <div className='h-[450px] w-[350px] text-[#474545] items-center flex flex-col  text-center shadow-xl rounded-[10px] p-5
            ...
            <h3 className='font-bold'>Residential</h3>
               ...
               <p>FOR HOMES</p>
               <br />
               <div className='h-[40px] w-[200px] rounded-[5px] flex justify-center items-center shadow-lg bg-[#3764E8] '>
                <p>Professional Cleaner</p>
               </div>
               <br />
